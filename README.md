...
Since 2G and 3G networks are starting to close down around the world I've started looking at alternatives to te MKR GSM 1400 board. The Arduino MKR NB 1500 seems to be a board that would work as a suitable replacement. Haven't looked closer into implementing that yet, but in my area the close-down won't happen until 2025, so I have some time to research this.
